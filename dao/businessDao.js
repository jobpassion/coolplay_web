...
exports.updateBusiness = function(business, callback){
    daoHelper.sql('update business set price = ?,tel=?,rating=?,taste=?,ambience=?,serving=? where id=?',[business.price, business.tel,business.rating,business.taste,business.ambience,business.serving, business.id], callback);
}
