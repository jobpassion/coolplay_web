...
(function() {
  var classMap, config, dateformat, pageLimit, publishSelectKey, queryPublish, queryPublishAddConstraint;
  ...
  queryPublishAddConstraint = function(param, cql, cqlParams) {
