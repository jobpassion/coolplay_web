...
(function() {
  var appendIfFriend, async, classMap, config, constructAVObject, errorConfig, queryFavorites, queryGuess, queryLikes, randomToken, recursiveToJson, simpleUser, userDao, weiboFriends, weiboService;
