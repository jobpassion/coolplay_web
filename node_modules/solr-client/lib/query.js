...
Query.prototype.spatial = function(bool){
	   var self = this;
	   var parameter = 'spatial=' + bool ;
	   this.parameters.push(parameter);
	   return self;
	}
Query.prototype.fq = function(fq){
	   var self = this;
	   var parameter = 'fq=' + fq ;
	   this.parameters.push(parameter);
	   return self;
	}
Query.prototype.sfield = function(sfield){
	   var self = this;
	   var parameter = 'sfield=' + sfield ;
	   this.parameters.push(parameter);
	   return self;
	}
Query.prototype.pt = function(pt){
	   var self = this;
	   var parameter = 'pt=' + pt ;
	   this.parameters.push(parameter);
	   return self;
	}
Query.prototype.d = function(d){
	   var self = this;
	   var parameter = 'd=' + d ;
	   this.parameters.push(parameter);
	   return self;
